...
export default function Home() {
  ...
  return (
    <div className="site-shell">
      ...
      <footer><div className="container footer-inner"><a className="brand footer-brand" href="#inicio"><span className="brand-mark"><Factory size={20} /></span><span>SERVICIOS<br /><em>INTEGRALES</em></span></a><p>Fabricación a medida y mantenimiento industrial.<br />Mendoza, Argentina.<br />Hugo David Murua · +54 9 261 555 0182</p><a className="whatsapp-link" href="https://wa.me/5492615384243?text=Hola%2C%20vi%20su%20web%20y%20necesito%20cotizar%20un%20servicio%20industrial." target="_blank" rel="noreferrer"><MessageCircle size={17} /> Urgencias de mantenimiento 24/7</a><span className="footer-copy">© 2026 · Todos los derechos reservados</span></div></footer>
