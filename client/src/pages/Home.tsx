...
const portfolioItems = [
  ...
  { image: portfolioImage("obra-26.webp", "obra-26_78b67f1e.webp"), category: "fabricacion", label: "Fabricación y montaje", title: "Mesa vibrante" },
  { image: portfolioImage("obra-27.webp", "obra-27_692ce33f.webp"), category: "fabricacion", label: "Fabricación y montaje", title: "Esqueleto de cinta de transporte" },
  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="final-cta"><div className="container final-cta-inner"><div><div className="eyebrow light"><span className="eyebrow-line" /> ¿TENÉS UN TRABAJO PARA CONSULTAR?</div><h2>Mandanos los datos del trabajo.<br /><em>Lo revisamos juntos.</em></h2><div className="cta-location"><MapPin size={17} strokeWidth={1.8} aria-hidden="true" /><span><strong>Donde encontrarnos:</strong> Esquina Tte. H. Volponi - Toribio Barrionuevo</span></div><p className="cta-location-note">Coordiná previamente tu visita por WhatsApp.</p></div><a className="btn btn-safety btn-lg" href="#cotizar">Consultar trabajo <ArrowRight size={18} /></a></div></section>
      </main>
