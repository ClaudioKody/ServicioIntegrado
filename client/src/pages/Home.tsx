...
export default function Home() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const message = `Hola Hugo, vi la web de SINT Electromecánica - Servicio Integrado. Soy ${formData.get("name")} y necesito consultar: ${formData.get("message")}. Mi WhatsApp es ${formData.get("phone")}.`;
  ...
  return (
    <div className="site-shell">
      <div className="topline"><div className="container d-flex justify-content-between align-items-center"><span>TALLER METALÚRGICO · MENDOZA</span><span className="topline-right"><Clock3 size={14} /> Consultas por WhatsApp</span></div></div>
      ...
      <main>
          ...
          <div className="container hero-content">
            <div className="row align-items-center g-5">
              <div className="col-lg-7 hero-copy">
                ...
                <h1>Trabajos metalúrgicos.<br /><span>Soluciones</span> a medida.</h1>
        ...
        <section id="caso" className="case-section"><div className="container"><div className="case-label">TRABAJO DESTACADO</div><div className="row g-0 case-wrap"><div className="col-12 case-copy case-copy-wide"><div className="eyebrow light"><span className="eyebrow-line" /> TRABAJO REAL</div><h2>Reparación de un eje.<br /><em>Trabajo listo para volver a usar.</em></h2><div className="case-row"><span>DESAFÍO</span><p>Reconstruir un componente desgastado sin esperar semanas por un repuesto importado.</p></div><div className="case-row"><span>SOLUCIÓN</span><p>Relevamiento, mecanizado de precisión y ajuste final con control dimensional.</p></div><div className="case-result"><strong>Trabajo a medida</strong><span>con mecanizado y control dimensional.</span></div><a href="#cotizar" className="btn btn-safety">Consultar un trabajo similar <ArrowRight size={17} /></a></div></div></div></section>
