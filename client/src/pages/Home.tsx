...
const portfolioItems = [
  ...
  { image: portfolioImage("obra-02.webp", "obra-02_5802d7d1.webp"), category: "tableros", label: "Tableros y control", title: "Gabinete eléctrico con señalización" },
  { image: portfolioImage("obra-03.webp", "obra-03_e05930a8.webp"), category: "instalaciones", label: "Instalaciones industriales", title: "Cañerías de servicio en exterior" },
  { image: portfolioImage("obra-04.webp", "obra-04_a85a91fb.webp"), category: "mantenimiento", label: "Mantenimiento en planta", title: "Bomba, motor y válvulas en mantenimiento" },
  { image: portfolioImage("obra-05.webp", "obra-05_43d9cbef.webp"), category: "instalaciones", label: "Instalaciones industriales", title: "Rejilla metálica para canal de servicio" },
  { image: portfolioImage("obra-06.webp", "obra-06_c9390aa3.webp"), category: "fabricacion", label: "Fabricación y montaje", title: "Base estructural soldada para equipo" },
  { image: portfolioImage("obra-07.webp", "obra-07_6f5ff259.webp"), category: "mantenimiento", label: "Mantenimiento en planta", title: "Conexiones flexibles de circuito hidráulico" },
  { image: portfolioImage("obra-08.webp", "obra-08_d864d2fa.webp"), category: "instalaciones", label: "Instalaciones industriales", title: "Equipos de proceso en planta" },
  { image: portfolioImage("obra-09.webp", "obra-09_fc1876a9.webp"), category: "tableros", label: "Tableros y control", title: "Tablero de control con cableado" },
  { image: portfolioImage("obra-10.webp", "obra-10_b02ca974.webp"), category: "instalaciones", label: "Instalaciones industriales", title: "Montaje de equipos en nave industrial" },
  { image: portfolioImage("obra-11.webp", "obra-11_5892cc6c.webp"), category: "mantenimiento", label: "Mantenimiento en planta", title: "Equipo de proceso en acero inoxidable" },
  { image: portfolioImage("obra-12.webp", "obra-12_4684b4b9.webp"), category: "mantenimiento", label: "Mantenimiento en planta", title: "Reductor con engranajes en revisión" },
  { image: portfolioImage("obra-13.webp", "obra-13_beaf7189.webp"), category: "mantenimiento", label: "Mantenimiento en planta", title: "Reductor y engranajes de transmisión" },
  { image: portfolioImage("obra-14.webp", "obra-14_3cc34af2.webp"), category: "fabricacion", label: "Fabricación y montaje", title: "Tolva y canal de descarga en acero inoxidable" },
  { image: portfolioImage("obra-15.webp", "obra-15_f05c5b03.webp"), category: "instalaciones", label: "Instalaciones industriales", title: "Instalación industrial en planta" },
  { image: portfolioImage("obra-16.webp", "obra-16_408262e1.webp"), category: "fabricacion", label: "Fabricación y montaje", title: "Cisterna industrial identificada en planta" },
  ...
  { image: portfolioImage("obra-18.webp", "obra-18_1d9fdff9.webp"), category: "mecanizado", label: "Mecanizado y reparación", title: "Piñón y cadena de transmisión" },
  { image: portfolioImage("obra-19.webp", "obra-19_227fe27f.webp"), category: "instalaciones", label: "Instalaciones industriales", title: "Red de tuberías y válvulas de proceso" },
  ...
  { image: portfolioImage("obra-27.webp", "obra-27_692ce33f.webp"), category: "fabricacion", label: "Fabricación y montaje", title: "Estructura de soporte en fabricación" },
  { image: portfolioImage("obra-28.webp", "obra-28_f37ef543.webp"), category: "mantenimiento", label: "Mantenimiento en planta", title: "Mantenimiento de equipo en planta" },
  { image: portfolioImage("obra-29.webp", "obra-29_96e04e67.webp"), category: "mecanizado", label: "Mecanizado y reparación", title: "Placa circular mecanizada" },
  { image: portfolioImage("obra-30.webp", "obra-30_9c1d6a7c.webp"), category: "mantenimiento", label: "Mantenimiento en planta", title: "Unión soldada de cañería" },
  { image: portfolioImage("obra-31.webp", "obra-31_875edf03.webp"), category: "instalaciones", label: "Instalaciones industriales", title: "Cañerías en canal técnico" },
  { image: portfolioImage("obra-32.webp", "obra-32_cf4895e9.webp"), category: "mantenimiento", label: "Mantenimiento en planta", title: "Bomba y válvulas en mantenimiento" },
];
...
export default function Home() {
  ...
  const [loadedPortfolioImages, setLoadedPortfolioImages] = useState<Set<string>>(() => new Set());
  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="location-section section-space" aria-labelledby="location-title"><div className="container"><div className="location-card"><div className="location-mark"><MapPin size={24} strokeWidth={1.8} aria-hidden="true" /></div><div><div className="eyebrow"><span className="eyebrow-line" /> UBICACIÓN</div><h2 id="location-title">Donde encontrarnos:</h2><address>Esquina Tte. H. Volponi - Toribio Barrionuevo</address><p>Coordiná previamente tu visita por WhatsApp.</p></div><a className="location-contact" href="#cotizar">Consultar antes de venir <ArrowRight size={16} /></a></div></div></section>
