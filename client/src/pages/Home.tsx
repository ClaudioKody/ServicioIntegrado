  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="clients-section"><div className="container clients-inner"><div className="clients-copy"><div className="eyebrow"><span className="eyebrow-line" /> CLIENTES</div><h2 className="display-title">Empresas que ya<br /><em>confían en nosotros.</em></h2><p>Una selección de empresas y organizaciones que han confiado en nuestra capacidad técnica y respuesta industrial.</p><div className="clients-proof"><Star size={22} strokeWidth={1.8} aria-hidden="true" /><span>Empresas y organizaciones<br />que confían en nuestro trabajo</span></div></div><div className="client-marquee" aria-label="Empresas clientes"><div className="client-track client-track-forward"><div className="client-pill"><img className="client-logo-image" src="/assets/client-logos/agroisme.svg" alt="Logo Agroisme" /></div><div className="client-pill"><Star size={14} strokeWidth={1.8} aria-hidden="true" /><span>EDEMSA</span></div><div className="client-pill"><img className="client-logo-image" src="/assets/client-logos/enershop.png" alt="Logo Ener Shop" /></div><div className="client-pill"><img className="client-logo-image" src="/assets/client-logos/jugos-australes.png" alt="Logo Jugos Australes" /></div><div className="client-pill"><img className="client-logo-image" src="/assets/client-logos/agroisme.svg" alt="Logo Agroisme" /></div><div className="client-pill"><Star size={14} strokeWidth={1.8} aria-hidden="true" /><span>EDEMSA</span></div><div className="client-pill"><img className="client-logo-image" src="/assets/client-logos/enershop.png" alt="Logo Ener Shop" /></div><div className="client-pill"><img className="client-logo-image" src="/assets/client-logos/jugos-australes.png" alt="Logo Jugos Australes" /></div></div><div className="client-track client-track-reverse"><div className="client-pill"><Star size={14} strokeWidth={1.8} aria-hidden="true" /><span>TELECOM</span></div><div className="client-pill"><img className="client-logo-image" src="/assets/client-logos/pulenta.png" alt="Logo Bodegas Pulenta" /></div><div className="client-pill"><img className="client-logo-image" src="/assets/client-logos/molinos-florencia.svg" alt="Logo Molinos Florencia" /></div><div className="client-pill"><Star size={14} strokeWidth={1.8} aria-hidden="true" /><span>COOPERATIVA TUP</span></div><div className="client-pill"><Star size={14} strokeWidth={1.8} aria-hidden="true" /><span>TELECOM</span></div><div className="client-pill"><img className="client-logo-image" src="/assets/client-logos/pulenta.png" alt="Logo Bodegas Pulenta" /></div><div className="client-pill"><img className="client-logo-image" src="/assets/client-logos/molinos-florencia.svg" alt="Logo Molinos Florencia" /></div><div className="client-pill"><Star size={14} strokeWidth={1.8} aria-hidden="true" /><span>COOPERATIVA TUP</span></div></div></div></div></section>
