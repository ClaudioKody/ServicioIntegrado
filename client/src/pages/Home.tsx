  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="clients-section"><div className="container clients-inner"><div className="clients-copy"><div className="eyebrow"><span className="eyebrow-line" /> CLIENTES</div><h2 className="display-title">Empresas que ya<br /><em>confían en nosotros.</em></h2><p>Una selección de empresas y organizaciones que han confiado en nuestra capacidad técnica y respuesta industrial.</p><div className="clients-proof"><strong>08</strong><span>organizaciones<br />atendidas</span></div></div><div className="client-marquee" aria-label="Empresas clientes"><div className="client-track client-track-forward"><div className="client-pill"><small>01</small><span>AGROISME</span></div><div className="client-pill"><small>02</small><span>EDEMSA</span></div><div className="client-pill"><small>03</small><span>ENER SHOP</span></div><div className="client-pill"><small>04</small><span>JUGOS AUSTRALES</span></div><div className="client-pill"><small>01</small><span>AGROISME</span></div><div className="client-pill"><small>02</small><span>EDEMSA</span></div><div className="client-pill"><small>03</small><span>ENER SHOP</span></div><div className="client-pill"><small>04</small><span>JUGOS AUSTRALES</span></div></div><div className="client-track client-track-reverse"><div className="client-pill"><small>05</small><span>TELECOM</span></div><div className="client-pill"><small>06</small><span>BODEGAS PULENTA</span></div><div className="client-pill"><small>07</small><span>MOLINOS FLORENCIA</span></div><div className="client-pill"><small>08</small><span>COOPERATIVA TUP</span></div><div className="client-pill"><small>05</small><span>TELECOM</span></div><div className="client-pill"><small>06</small><span>BODEGAS PULENTA</span></div><div className="client-pill"><small>07</small><span>MOLINOS FLORENCIA</span></div><div className="client-pill"><small>08</small><span>COOPERATIVA TUP</span></div></div></div></div></section>
