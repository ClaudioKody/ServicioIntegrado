  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="gallery-section section-space"><div className="container"><div className="section-heading-row"><div><div className="eyebrow"><span className="eyebrow-line" /> TRABAJOS REALES</div><h2 className="display-title">Lo que hacemos,<br /><em>se puede ver.</em></h2></div><p className="gallery-note">Galería preparada para sumar fotos reales de trabajos, sin fechas ni etapas forzadas: cada proyecto puede contar su propia historia.</p></div><div className="gallery-grid"><figure className="gallery-card"><img src={img.cnc} alt="Mecanizado CNC de precisión" /><figcaption><span>MECANIZADO</span><strong>Precisión<br />que produce.</strong></figcaption></figure><figure className="gallery-card"><img src={img.fabrication} alt="Fabricación de estructuras metálicas" /><figcaption><span>FABRICACIÓN</span><strong>Del plano<br />a la planta.</strong></figcaption></figure><div className="gallery-caption"><span>PORTFOLIO EDITABLE</span><strong>Sumamos tus<br />trabajos reales.</strong><p>Cuando tengas las fotos, reemplazamos estas piezas sin cambiar la estructura.</p><a href="#cotizar">Quiero sumar un trabajo <ArrowRight size={16} /></a></div></div></div></section>
