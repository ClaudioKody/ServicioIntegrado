  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="clients-section"><div className="container clients-inner"><div><div className="eyebrow"><span className="eyebrow-line" /> CLIENTES</div><h2 className="display-title">Empresas que ya<br /><em>confían en nosotros.</em></h2><p>Una selección de empresas y organizaciones que han confiado en nuestra capacidad técnica y respuesta industrial.</p></div><div className="client-placeholder"><span>EMPRESAS QUE CONFÍAN EN NUESTRO TRABAJO</span><div className="client-names" aria-label="Empresas clientes"><span>AGROISME</span><span>EDEMSA</span><span>ENER SHOP</span><span>JUGOS AUSTRALES</span><span>TELECOM</span><span>BODEGAS PULENTA</span><span>MOLINOS FLORENCIA</span><span>COOPERATIVA TUP</span><span>AGROISME</span><span>EDEMSA</span><span>ENER SHOP</span><span>JUGOS AUSTRALES</span><span>TELECOM</span><span>BODEGAS PULENTA</span><span>MOLINOS FLORENCIA</span><span>COOPERATIVA TUP</span></div></div></div></section>
